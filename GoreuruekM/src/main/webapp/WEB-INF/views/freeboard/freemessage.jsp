...
$(function(){
	$("#modalMessage${vs.index}").click(function(){
		...
		$("#form5${vs.index}").submit();
		
	});
});
</script>
<div class="modal fade" id="myModal5${vs.index}" role="dialog">

    <div class="modal-dialog">
 	
        <!-- Modal content-->
        <form name="form5" id="form5${vs.index}" method="post" action="${contextPath }/freeboard/message?${_csrf.parameterName}=${_csrf.token}">
            ...
            <div class="modal-body">
                <table class="table">
                    <tr>
                        <td>받는아이디</td>
                        <td>
                        	<input class="form-control" id="userName3${vs.index}" type="text" readonly="readonly" value="${list.FB_MMID }" style="width: 100%"/>
                        	<input type="hidden" id="TARGET_MMID${vs.index}" name="TARGET_MMID" value="${list.FB_MMID }"/>
                        </td>
                    </tr>
