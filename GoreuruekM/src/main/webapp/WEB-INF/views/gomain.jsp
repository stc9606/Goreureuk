	...
	<header class="header-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    <div class="logo-area">
                        <a href="index.html" style="color: #f15858"><img src="${contextPath }/resources/assets/images/logo/logo.png" alt="logo">꼬르륵</a>
                    </div>
                </div>
                <div class="col-lg-10">
                    ...
                    <div class="main-menu">
                        <ul>
                            <li class="active"><a href="index.html" style="color: #f15858">home</a></li>
                            <li><a href="about.html" style="color: #f15858">소개</a></li>
                            <li><a href="menu.html" style="color: #f15858">먹스타</a></li>
                            <li><a href="#" style="color: #f15858">요리를 부탁해</a>
                                <ul class="sub-menu">
                                    <li><a href="blog-home.html">Blog Home</a></li>
                                    <li><a href="blog-details.html">Blog Details</a></li>
                                </ul>
                            </li>
                            <li><a href="contact-us.html" style="color: #f15858">팁</a></li>
                            <li><a href="elements.html" style="color: #f15858">공지사항</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6 align-self-center">
                    <div class="welcome-img">
                        <img src="${contextPath }/resources/assets/images/welcome-bg.png" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-6 align-self-center">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/food1.jpg" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-sm-0">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/food2.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5 mt-md-0">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/food3.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>topu lasange</h5>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/food4.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/food5.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
                                <h5>bean salad</h5>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-food mt-5">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/food6.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="d-flex justify-content-between">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src="${contextPath }/resources/assets/images/deshes1.png" alt="" class="img-fluid">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="${contextPath }/resources/assets/images/deshes2.png" alt="" class="img-fluid">
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/update1.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                ...
                <div class="col-md-4">
                    <div class="single-food my-5 my-md-0">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/update2.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="post-admin d-lg-flex mb-3">
                                <span class="mr-5 d-block mb-2 mb-lg-0"><i class="fa fa-user-o mr-2"></i>Admin</span>
                ...
                <div class="col-md-4">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="${contextPath }/resources/assets/images/update3.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="food-content">
                            <div class="post-admin d-lg-flex mb-3">
                                <span class="mr-5 d-block mb-2 mb-lg-0"><i class="fa fa-user-o mr-2"></i>Admin</span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="single-widget single-widget1">
                            <a href="index.html"><img src="${contextPath }/resources/assets/images/logo/logo2.png" alt=""></a>
                            <p class="mt-3" style="color: white">Which morning fourth great won't is to fly bearing man. Called unto shall seed, deep, herb set seed land divide after over first creeping. First creature set upon stars deep male gathered said she'd an image spirit our</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-widget single-widget2 my-5 my-md-0">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="info-text">
                                    <p style="color: white">1234 Some St San Francisco, CA 94102, US 1.800.123.4567 </p>
                                </div>
                            </div>
                            <div class="d-flex">
                                <div class="into-icon" style="color: white">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="info-text">
                                    <p style="color: white">support@axiomthemes.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="single-widget single-widget3">
                            ...
                            <p style="color: white">Monday ...................... Closed</p>
                            <p style="color: white">Tue-Fri .............. 10 am - 12 pm</p>
                            <p style="color: white">Sat-Sun ............... 8 am - 11 pm</p>
                            <p style="color: white">Holidays ............. 10 am - 12 pm</p>
                        </div>
                    </div>
                </div>
            </div>
